...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// className
	Expr.find[ "className" ] = support.getElementsByclassNameName && function( className, context ) {
		if ( typeof context.getElementsByclassNameName !== "undefined" && documentIsHTML ) {
			return context.getElementsByclassNameName( className );
		}
	};
		...
		"className": function( className ) {
			...
			return pattern ||
				( pattern = new RegExp( "(^|" + whitespace +
					")" + className + "(" + whitespace + "|$)" ) ) && classNameCache(
...
jQuery.fn.extend( {
	...
	toggleclassName: function( value, stateVal ) {
		...
		return this.each( function() {
			var className, i, self, classNameNames;
			...
			if ( isValidValue ) {
				...
				while ( ( className = classNameNames[ i++ ] ) ) {
			...
			// Toggle whole className name
				...
				if ( className ) {
					...
					dataPriv.set( this, "__classNameName__", className );
				}
