...
class RecetteParMois extends AbstractController
{
    ...
    {    if ($this->security->isGranted('ROLE_ADMIN')) {
        # code...
        return($commandeRepository->recettesParMois($id));
    }
    elseif ($this->security->isGranted('ROLE_SELLER'))
        {
            return($commandeRepository->recettesParMois($this->security->getUser()->getId()));
        }
        else
        {
            $responseData = [
